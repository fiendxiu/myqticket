...
if($search):
    ...
    if($searchTerm){
        ...
        if (is_numeric($searchTerm)) {
            ...
            //    $qwhere .= ' AND false';
            $deep_search=true;
            $queryterm = Format::htmlchars($queryterm, true);
            $qwhere .= " AND thread.title LIKE '%$queryterm%' OR user.name LIKE '%$queryterm%'";
        }
   }
...
<div id='basic_search'>
    ...
    <table>
	    ...
	    <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://ticket.fnetlink.com:10090/scp/" target="view_window">[旧ticket]</a>&nbsp;</td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://43.229.117.88:10083/tquality/" target="view_window">[TICKET每日统计]</a>&nbsp;</td>
        </tr>
    </table>
    </form>
</div>
    ...
    <thead>
        <tr>
            ...
            <?php
                ...
                <th width="60" >
                    <a href="tickets.php?sort=&order=<?php echo $qstr; ?>"
